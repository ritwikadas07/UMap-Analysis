...
# Function to load pre-trained VAE encoder, decoder, and latent space
def load_vae_model():
...
def load_digits_dataset():
    ...
    digits_df.columns = digits_df.columns.astype(str)  # Ensure column names are strings
...
def load_fashion_mnist_dataset():
    ...
    fashion_mnist_df.columns = fashion_mnist_df.columns.astype(str)  # Ensure column names are strings
